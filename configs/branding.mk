...
LUCID_VERSION := $(LUCID_VERSION_MAJ).$(LUCID_VERSION_MIN)-$(shell date -u +%Y%m%d_%H%M%S)-$(LUCID_BUILDTYPE)-$(LUCID_BUILD)
LINEAGE_DISPLAY_VERSION := $(LUCID_VERSION_MAJ).$(LUCID_VERSION_MIN)
