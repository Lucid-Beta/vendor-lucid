...
"""
Merge script for Lucid Project
 The source directory; this is automatically two folder up because the script
 is located in vendor/lucid/scripts. Other ROMs will need to change this. The logic is
 as follows:
...
MANIFEST_NAME = "goodies/lucid.xml"
REPOS_TO_MERGE = [".repo/manifests"]
BRANCH_STR = "android-10.0.0_r36"
REPOS_RESULTS = {}
